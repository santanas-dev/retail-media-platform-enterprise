...
**Current phase:** 4.1d (Campaign Approval Workflow)
...
| S-005 | Campaign approval workflow | P2 | ✅ done | — | 3 endpoints (request-approval/approve/reject), status transitions, approval records, outbox, 15 unit + 16 behavioral tests | — |
