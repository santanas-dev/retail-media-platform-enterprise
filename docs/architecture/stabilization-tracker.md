...
| S-006c | Manifest generator worker | P2 | open | — | NATS consumer, target resolution, manifest JSON gen, presigned URLs, signing, MinIO upload | Phase 4.2d: device gateway delivery endpoint |
