...
| S-088 | Rules management UI (CRUD) | S-077, S-080 | 5 endpoints: list/create/update/activate/deactivate. Validation: rule_type, scope, value_json per type. Admin-web: RulesTab with table + modal form. |
