...
| Revision | `draft-2026-08-26-r8`; увеличивается при каждом содержательном изменении |
...
| Content | `media_assets`, `creative_versions`, `creative_moderation_tasks`, `content_renditions`, `rendition_requirements` |
...
| Governance | `approval_tasks`, `approval_decisions`, `emergency_events`, `emergency_targets`, `audit_events_operational` |
...
Для каждого раздела фиксируются route, role/scope, primary action, таблица/фильтры,
empty/loading/error/403/success состояния, массовые операции, прогресс долгих операций,
следующий шаг и audit. Обязательные экраны:
...
- Observability: trace/correlation ID, dashboards для IT/business/ИБ, alert thresholds,
  incident runbook, SLO/error budget и связь с SLA кампании.
...
| REQ-BIZ-001…007 | §1.2, §3, §6.2–6.3, §22.1–22.6 | бизнес-цикл, flight windows, типы/приоритеты, inventory, eligibility, SLA, компенсации, quality report |
| REQ-CONT-001/002 | §7, §22.5 | форматы, QA, renditions, версии, malware/HTML5 policy |
| REQ-MAN-001…003, REQ-ORCH-001…004, REQ-POP-001…004 | §8–11, §23–24 | playlist/manifest, edge safety, adapters, triggers/outbox, Orchestrator, PoP |
...
| REQ-SEC-001 | Identity and MFA | SSO/AD, break-glass, session policy |
...
| REQ-OPS-004 | Observability | trace, metrics, alerts, incident runbooks |
| REQ-OPS-005 | Operational readiness | инструкции запуска/остановки/обновления/отката/восстановления, systemd/restart policy для player и отдельная health-панель сервисов, БД, очереди, media, устройств и PoP |
...
| REQ-UX-001 | Role-specific portal | route/action/state/accessibility matrix, advertiser export PDF/XLSX/CSV |
...
| REQ-DATA-001 | Data ownership and lifecycle | dictionary, lineage, PII, retention, archive/delete; технические логи 90–180 дней до owner/legal decision |
...
и retention. Юрист/ИБ отдельно утверждают 152-ФЗ, юридический статус PDF, audit immutability,
...
| §4 Архитектура/стек/сеть | REQ-ARCH-001, REQ-ARCH-002, REQ-ARCH-003, REQ-CORE-001, REQ-CORE-002, REQ-API-002, REQ-SEC-001, REQ-SEC-002, REQ-SEC-003, REQ-SEC-004, REQ-SEC-005, REQ-OPS-001, REQ-OPS-004 | domain/ERD + network/deploy design |
| §5 NFR | REQ-NFR-001, REQ-NFR-003, REQ-NFR-004, REQ-NFR-005, REQ-NFR-006, REQ-OPS-003, REQ-OPS-004 | SLO/load/DR evidence |
| §6 Роли/кампании/инвентарь | REQ-BIZ-001, REQ-BIZ-003, REQ-BIZ-005, REQ-BIZ-006, REQ-BIZ-007, REQ-CORE-003, REQ-UX-001, REQ-SEC-002 | role matrix + formulas + journeys |
...
| §12 Reports | REQ-BIZ-001, REQ-BIZ-002, REQ-BIZ-004, REQ-POP-001, REQ-UX-001 | report schema + plan/fact/channel-quality evidence |
...
| §22 Best practices | REQ-BIZ-001, REQ-BIZ-002, REQ-BIZ-003, REQ-BIZ-004, REQ-BIZ-005, REQ-BIZ-006, REQ-BIZ-007, REQ-CONT-001, REQ-CONT-002, REQ-OPS-001, REQ-OPS-002, REQ-OPS-003, REQ-OPS-004, REQ-OPS-005, REQ-UX-001, REQ-UX-002, REQ-UX-003, REQ-NFR-005, REQ-NFR-006, REQ-SEC-005, REQ-STAND-002 | atomic IDs by subsection |
| §23 Multichannel | REQ-CHAN-001, REQ-CHAN-002, REQ-CORE-003, REQ-MAN-003, REQ-ORCH-001, REQ-ORCH-002, REQ-ORCH-003, REQ-ORCH-004, REQ-POP-001, REQ-POP-002, REQ-POP-003, REQ-POP-004 | adapter/channel matrix + contracts |
| §24 Architecture v2.5 | REQ-ARCH-001, REQ-ARCH-002, REQ-ARCH-003, REQ-CORE-001, REQ-CORE-002, REQ-CORE-003, REQ-BIZ-005, REQ-BIZ-006, REQ-ORCH-001, REQ-ORCH-002, REQ-ORCH-003, REQ-ORCH-004, REQ-MAN-001, REQ-MAN-002, REQ-MAN-003, REQ-POP-004, REQ-API-001, REQ-API-002, REQ-API-003 | ADR alignment + architecture acceptance |
...
| §22.10 | logs, metrics, traces, alerts и три типа dashboard |
...
До закрытия AC-01…AC-21 документ остаётся `DRAFT/REVIEW`; текст без артефакта и evidence не считается покрытием.
...
обязанностей. Текущие 57 REQ и карта 25 разделов не доказывают, что все 149 строк
...
маркер вида `[REQ-XXX-000]` либо находиться в строке каталога REQ. Проверка проходит в
