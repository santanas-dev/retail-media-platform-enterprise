...
> **`192.168.110.77` недостижим на момент проверки (RM-ENV-001, 2026-08-26):**
...
>
> Вывод `.77` из эксплуатации или его обновление — **решение владельца**, оно не
> принято; здесь зафиксировано только наблюдение.
