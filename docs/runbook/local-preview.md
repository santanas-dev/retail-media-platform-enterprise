...
192.168.110.77 выведен из эксплуатации решением владельца OD-016 (2026-08-26).
Активный контур — стенд 192.168.110.81 (stand-27dc397, schema 036).
Инвентарь окружений: docs/product/environment-inventory.yaml
-->

> **`192.168.110.77` выведен из эксплуатации (OD-016, 2026-08-26).**
> Наблюдение RM-ENV-001 до решения:
> `curl` к `:3000`, `:3001` и `:8000` даёт код `000`. Адреса ниже сохранены как
> историческая конфигурация S-026, а не как рабочая точка входа.
>
> Активный контур с доказательной силой — стенд `192.168.110.81`
> (`stand-27dc397`, schema `036`). Полный разбор, включая то, что именно каждое
> окружение доказывает, — `docs/product/environment-inventory.yaml`.
>
> Решение принято владельцем 2026-08-26 (OD-016). Адреса ниже сохранены как
> историческая конфигурация S-026.
