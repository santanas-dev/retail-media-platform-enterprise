...
**Last updated:** 2026-07-23 (CAMPAIGN-UX-001A — creative.upload human-path: primary upload UI + smoke + vitest)
...
**CAMPAIGN-UX-001A** — creative.upload human-path: явная загрузка файла с ПК. Implementation ready (FU2: org-id guard + vitest payload assertion). Operator walkthrough pending.
