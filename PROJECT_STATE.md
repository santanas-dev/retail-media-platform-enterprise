...
**Last updated:** 2026-08-25 (AUTHZ-CROSS-PORTAL-001 — security bundle `stand-da8d514` выкачен на стенд)

**Next Active Workstream:** **CAMPAIGN-PERMISSION-SPLIT-001** — разделить self-service brief permission и operator campaign management (`campaigns.manage` перегружен). PORTAL-UX-POLISH и OWNER-UX-DECISION-001 остаются на паузе.
...
- State/Docs SHA: `0908c91` (develop — LOCAL-DEV-STAND-001 stand tooling). Stand bundle SHA **`da8d514`** (`stand-da8d514`, security bundle AUTHZ-CROSS-PORTAL-001; предыдущий — `4635e72`). Payload SHA `8ad0228` unchanged — pilot/production release не менялся, `v0.11.1` не трогался.
