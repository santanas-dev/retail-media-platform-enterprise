...
|---------|-------------|----------------|------|
| develop | 7a6444f | 0346ea1 | JOURNEY-006 advertiser.view reachable, CI #29934268801 ✅ |
| main    | 3d201d6     | —               | R1 release — K1/K2/RM1/CLEAN-BOOT-001 |
| NAS mirror (ASUSTOR) | pending | 7a6444f | Hermes cron, syncing after JOURNEY-006 push |
