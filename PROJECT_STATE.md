...
**Last updated:** 2026-08-26 (LOCAL-DEV-STAND-001-FU-IDENTITY-SMOKE — identity переключается сам, smoke больше не трогает общие данные)

**Next Active Workstream:** **PORTAL-UX-POLISH-001A1a** — минимальные общие примитивы и контракты UI (нарезка A1a → A3 → A2 → A4 → A6 → A1b → A5 → A7).
...
- State/Docs SHA: `0908c91` (develop — LOCAL-DEV-STAND-001 stand tooling). Stand bundle SHA **`c088111`** (`stand-c088111`; lock перевыпущен с `schema_head: 036`, digest'ы и SHA те же — предыдущие бандлы `da8d514`, `4635e72`). Payload SHA `8ad0228` unchanged — pilot/production release не менялся, `v0.11.1` не трогался.
