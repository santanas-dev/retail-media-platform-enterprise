...
const S = {
  ...
  btnDisabled: { padding: "0.7rem 1.5rem", border: "none", borderRadius: 6, background: "#93c5fd", color: "var(--rmp-text-inverse)", fontWeight: 600, fontSize: "1rem", cursor: "not-allowed", alignSelf: "flex-start" as const },
