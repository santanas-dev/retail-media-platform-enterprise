...
const S = {
  ...
  btn: { padding: "0.7rem 1.5rem", border: "none", borderRadius: 6, background: "var(--rmp-primary-500)", color: "var(--rmp-text-inverse)", fontWeight: 600, fontSize: "1rem", cursor: "pointer", alignSelf: "flex-start" as const },
  btnDisabled: { padding: "0.7rem 1.5rem", border: "none", borderRadius: 6, background: "var(--rmp-primary-300)", color: "var(--rmp-text-inverse)", fontWeight: 600, fontSize: "1rem", cursor: "not-allowed", alignSelf: "flex-start" as const },
