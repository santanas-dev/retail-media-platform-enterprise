...
const styles = {
  ...
  card: { padding: "1.5rem", borderRadius: 8, background: "#fff", border: "1px solid var(--rmp-border)", marginBottom: "1.5rem" },
  ...
  btnDanger: { padding: "0.6rem 1.2rem", border: "none", borderRadius: 6, background: "var(--rmp-danger-600)", color: "#fff", fontWeight: 600, cursor: "pointer", fontSize: "0.9rem" },
  btnSecondary: { padding: "0.5rem 1rem", border: "1px solid var(--rmp-border-strong)", borderRadius: 4, background: "#fff", cursor: "pointer", fontSize: "0.85rem" },
