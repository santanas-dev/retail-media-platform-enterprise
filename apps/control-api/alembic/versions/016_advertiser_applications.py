...
def upgrade() -> None:
    ...
    op.create_index("ix_advertiser_applications_status", "advertiser_applications", ["status"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_advertiser_applications_status", table_name="advertiser_applications")
